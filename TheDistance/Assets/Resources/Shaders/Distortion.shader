...
Shader "Shader Forge/Distortion" {
    Properties {
        ...
        _DistortionPercent ("Distortion Percent", Range(0, 0.1)) = 0.1
...
////// Emissive:
                ...
                float2 node_5488 = (i.uv0+(node_2582.r*_WaveSpeed)*float2(1,1));
