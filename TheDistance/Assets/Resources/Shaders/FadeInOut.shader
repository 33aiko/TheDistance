...
////// Emissive:
                ...
                return fixed4(finalColor,(node_603*saturate((node_5586*((1.0 - length((i.uv0*1.0+-0.5)))+0.1)*3.0))));
            }
            ENDCG
        }
        Pass {
