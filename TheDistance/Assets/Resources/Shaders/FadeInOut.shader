...
Shader "Shader Forge/FadeInOut" {
    Properties {
        ...
        _DissolveAmount ("Dissolve Amount", Range(0, 1)) = 0.3675214
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float node_6642 = (((1.0 - _DissolveAmount)*1.2+-0.6)+_Noise_var.r);
                clip(node_6642 - 0.5);
////// Lighting:
////// Emissive:
